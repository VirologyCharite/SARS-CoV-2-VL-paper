...
show_code = T
knitr::opts_chunk$set(echo = TRUE,warning=F, message=F, fig.width=9, fig.align= 'center',root.dir = here::here(), echo = show_code)
library(data.table)
setDTthreads(1)
library(here)
library(ggplot2)
...
## Association of viral load probability of a positive culture
