...
## create dirs to be used later
dir.create("figures", showWarnings = FALSE)
dir.create("pdata", showWarnings = FALSE)
dir.create("B117fits", showWarnings = FALSE)
dir.create("CP/fits/w25o", recursive = TRUE, showWarnings = FALSE)
```
...
## check pygmentize exists (assumed in "anaconda" dir)
pygmentize_bin = paste0(Sys.getenv("HOME"), "/anaconda/bin/pygmentize")
if (show_code == T && file.exists(pygmentize_bin)) {
  tf <- tempfile(fileext=".html")
  cmd = paste0(pygmentize_bin, " -o %s CP/stan/",model,".stan")
...
suppressWarnings(pander(my_sessioninfo))
```
